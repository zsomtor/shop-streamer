    ...
    <div className="flex min-h-screen items-center justify-center px-4">
      <div className="w-full max-w-md rounded-xl border border-dark-700 bg-dark-800 p-8">
        ...
        <div className="my-6 flex items-center gap-3">
          ...
          <span className="text-xs text-dark-500">VAGY</span>
          <div className="h-px flex-1 bg-dark-700" />
        </div>
        ...
        <div className="space-y-3">
          <button
            ...
            className="flex w-full items-center justify-center gap-3 rounded-lg border border-dark-600 bg-dark-850 px-4 py-2.5 text-sm font-medium text-dark-100 transition-colors hover:bg-dark-700"
          >
